...
public class MenuBot extends Robot {
    public MenuBot(OpMode opMode) {
        ...
        gui.addMenu("Menu 1", new ScrollingListTestMenu(gui, new DefaultCursor(this,0, 0, 500)));
        gui.addMenu("Menu 2", new ScrollingListTestMenu(gui, new DefaultCursor(this,0, 0, 500)));
        gui.addMenu("Menu 3", new ScrollingListTestMenu(gui, new DefaultCursor(this,0, 0, 500)));
    }
}

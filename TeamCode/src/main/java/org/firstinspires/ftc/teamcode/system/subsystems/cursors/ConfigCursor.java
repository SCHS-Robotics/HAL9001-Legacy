...
public class ConfigCursor extends Cursor {
    ...
    public boolean speed_mode = false;
    ...
    public void update() {
        ...
        if(inputs.getBooleanInput(SELECT) && (flag || (speed_mode && System.currentTimeMillis()-timeFromLastPressSelectMill > 200))){
            super.menu.onSelect();
            super.menu.onButton(SELECT,inputs.getButton(SELECT));
            timeFromLastPressSelectMill = System.currentTimeMillis();
            flag = false;
        }
        else if(inputs.getBooleanInput(REVERSE_SELECT) && (flag || (speed_mode && System.currentTimeMillis()-timeFromLastPressRSelectMill > 200))) {
